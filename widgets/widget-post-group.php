<?php
/*
 * Filename:      widget-post-group.php
 ...
 * Domain Path:   ./widgets
 * Description:   The pa_post_group class
...
add_action('widgets_init', create_function('', 'return register_widget("pa_post_group");'));

class pa_post_group extends WP_Widget {
    /**
    ...
    */
	function __construct() {
		parent::__construct(
			'pa_post_group',
			__('PA Post Group', 'widget_name'),
			array('description' => __('Display Post Group...'))
		);
	}
    ...
    */
	function widget($args, $instance) {
        ...
        require(WPPAGEASSEMBLER.'templates/template-post-group.php');
    }
