...
add_action('widgets_init', create_function('', 'return register_widget("widgetify_post_group");'));

class widgetify_post_group extends WP_Widget {
    /**
    ...
    */
	function __construct() {
		parent::__construct(
			'widgetify_post_group',
			__('Widgetify Post Group', 'widget_name'),
    ...
    */
	function widget($args, $instance) {
        ...
        require(WPWIDGETIFY.'templates/template-post-group.php');
    }
