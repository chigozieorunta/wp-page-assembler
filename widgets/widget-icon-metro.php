...
add_action('widgets_init', create_function('', 'return register_widget("widgetify_icon_metro");'));

class widgetify_icon_metro extends WP_Widget {
    /**
    ...
    */
	function __construct() {
		parent::__construct(
			'widgetify_icon_metro',
			__('Widgetify Icon Metro', 'widget_name'),
    ...
    */
	function widget($args, $instance) {
        ...
        require(WPWIDGETIFY.'templates/template-icon-metro.php');
    }
