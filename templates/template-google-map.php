...
<!--Google Map-->
<section class="widgetify-section widgetify-google-map <?= $instance['widgetClass']; ?>" style="background-color: #131313; <?php if($instance['widgetPadding']): ?>padding: <?= $instance['widgetPadding']; ?>px 0;<?php endif; ?>; height: <?= $instance['height']; ?>px" id="<?= $instance['widgetId']; ?>">
    <div class="mapouter">
